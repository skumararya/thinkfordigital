...
const PrivacyPolicy = () => {
  const { data: policyResponse, isLoading, isError } = useGetPageContentQuery("privacy-policy");
  ...
  return (
    <>
      <InnerBannerBreadCrumb pageTitle={"Privacy Policy"} title2={"Privacy Policy"} />
             ...
             <div className="row p-3">
                <div className="col-12">
                    <div className="profile-title text-left">
                        <h2>{policyData?.title || "Privacy Policy"}</h2>
